...
const HoursForm = ({ closeModal, activity_id }) => {
    ...
    const validationForm = Yup.object({
        ...
        minutes: Yup.number().oneOf([0, 15, 30, 45], 'Opción invalida').required('Requerido'),
        createdOn: Yup.date('Debe ingresar una fecha válida').required('Requerido'),
        commentary: Yup.string('kzdljfsflk').min(3, 'Agregar comentario').max(300, 'Comentario demasiado extenso').required('Requerido'),
    });
                ...
                <div className="form-group">
                    <div className="form-row">
                        <div className="col col-md-4">
                            ...
                            <div className="form-row">
                                <div>
                                    <button type="button" className="btn btn-primary form_buttons" onClick={decrement}>-</button>
                                </div>
                                ...
                                <div>
                                    <button type="button" className="btn btn-primary form_buttons" onClick={increment}>+</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <Field label="Fecha:" name="createdOn" component={CustomDateInput} onChange={handleChange} />
                    </div>
                </div>

                <div className="form-group">
                    <Field label="Comentarios:" name="commentary" component={CustomTextarea} onChange={handleChange} />
                </div>
