...
export const actions = {
    getHours: (userId) => ({ type: actionTypes.GetActivityHoursStart, userId }),
};

export function* getHoursState({ userId }) {
    try {
        const results = yield call(apiCall, `user/${userId}/activityHours`, null, 'GET');
